...
(function () {
  var dict = {
    ...
    'Content Management':'内容管理','Manage and organize your content items':'管理和组织您的内容项目','Model':'模型','Models':'模型','Blog Post':'博客文章','Blog Posts':'博客文章','Email Log':'邮件日志','Email Logs':'邮件日志','Redirect':'重定向','Redirects':'重定向','SEO Articles':'SEO 文章','SEO City Pages':'SEO 城市页面','City Pages':'城市页面','SEO Policy Interpretation':'SEO 政策解读','Policy Interpretation':'政策解读','Welcome to SonicJS':'欢迎使用 SonicJS','Welcome':'欢迎','Showing':'显示','results':'条结果','result':'条结果','Per page':'每页显示','No results':'暂无结果','No records found':'未找到记录','No records':'暂无记录','No data':'暂无数据','Filter':'筛选','Filters':'筛选条件','All Models':'全部模型','All Status':'全部状态','Status':'状态','Title':'标题','Description':'描述','Slug':'URL 别名','Content':'内容','Excerpt':'摘要','Category':'分类','Tags':'标签','Author':'作者','Updated':'更新时间','Created':'创建时间','Created At':'创建时间','Updated At':'更新时间','Published At':'发布时间','Published':'已发布','Unpublished':'未发布','Draft':'草稿','Under Review':'审核中','Scheduled':'已排期','Archived':'已归档','Deleted':'已删除','deleted':'已删除',
